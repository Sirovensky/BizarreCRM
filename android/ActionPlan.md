...
| 26 | Accessibility | ~80% | ReduceMotion util + Settings toggle + tests + BrandTopAppBar heading() + BrandListItem mergeDescendants/Role.Button + Dashboard (881b404) + Tickets (bf211de) + Customers (cda8fb0) + Invoices (3260c15) + Expenses (9883b2e) + Appointments (7270900) + Inventory (5e33ccb) + Estimates (060e229) + Leads (0332310) + SmsList (64729e0) + SmsThread (7ad7050) + **POS (73ac07b) + BarcodeScan (59e64e2) sweeps — 13 screens covered.** Missing: fontScale stress test, a11y framework tests, Settings sub-screens (Profile/Security/ChangePassword/SwitchUser/Theme/Language/Notifications), Reports tabs, Checkout. |
