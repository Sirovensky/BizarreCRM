...
| 26 | Accessibility | ~60% | ReduceMotion util + Settings toggle + tests + BrandTopAppBar heading() semantics + BrandListItem mergeDescendants/Role.Button + Dashboard (881b404) + Tickets (bf211de) + Customers (cda8fb0) + Invoices (3260c15) + Expenses (9883b2e) + **Appointments (7270900) + Inventory (5e33ccb) + Estimates (060e229) sweeps.** Missing: Leads + SMS lists, fontScale stress test, a11y framework tests. |
