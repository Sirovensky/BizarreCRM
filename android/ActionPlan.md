...
| 26 | Accessibility | ~72% | ReduceMotion util + Settings toggle + tests + BrandTopAppBar heading() semantics + BrandListItem mergeDescendants/Role.Button + Dashboard (881b404) + Tickets (bf211de) + Customers (cda8fb0) + Invoices (3260c15) + Expenses (9883b2e) + Appointments (7270900) + Inventory (5e33ccb) + Estimates (060e229) + **Leads (0332310) + SmsList (64729e0) + SmsThread (7ad7050) sweeps — 11 list/detail screens covered.** Missing: fontScale stress test, a11y framework tests, Settings sub-screens (Profile/Security/ChangePassword/SwitchUser/Theme/Language/Notifications), POS/Scanner/Camera, Reports tabs. |
