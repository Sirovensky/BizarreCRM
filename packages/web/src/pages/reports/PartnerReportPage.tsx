  ...
  return (
    <div className="p-6 max-w-3xl">
      <div className="flex items-center gap-2 mb-4">
        <Briefcase className="w-6 h-6 text-surface-600 dark:text-surface-400" aria-hidden="true" />
      ...
      <button
        ...
        onClick={openReport}
        disabled={generating}
        className="inline-flex items-center gap-2 rounded-lg bg-primary-600 px-4 py-2 text-on-primary hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none transition-colors"
      >
        {generating ? (
