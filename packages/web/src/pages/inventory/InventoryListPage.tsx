    ...
    <div className="flex flex-col h-full">
      <div className="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            to="/inventory/new"
            className="inline-flex items-center gap-2 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-on-primary rounded-lg font-medium text-sm transition-colors shadow-sm"
          >
      ...
      <div className="mb-4 flex items-center gap-2">
        <div className="relative max-w-md flex-1">
          ...
          <input
            ...
            autoCorrect="off"
            spellCheck={false}
            aria-label="Search inventory by name, SKU, or UPC"
      ...
      {showFilters && (
        <div className="mb-4 p-4 rounded-lg border border-surface-200 dark:border-surface-700 bg-surface-50 dark:bg-surface-800/50 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
          ...
          <div className="col-span-full flex gap-2 mt-1">
            <button onClick={applyFilters} className="px-3 py-1.5 text-sm font-medium rounded-md bg-primary-600 text-on-primary hover:bg-primary-700 transition-colors">
              Apply
            </button>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-1.5">
                    ...
                    <select
                      ...
                      value={pageSize}
                      onChange={(e) => { const v = e.target.value; try { localStorage.setItem('inventory_pagesize', v); } catch { /* private mode / quota */ } setSavedPageSize(Number(v)); const p = new URLSearchParams(searchParams); p.set('pagesize', v); p.set('page', '1'); setSearchParams(p, { replace: true }); }}
          ...
          <div className="bg-white dark:bg-surface-900 rounded-xl shadow-xl p-6 w-full max-w-md max-h-[80vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                className="px-4 py-2 text-sm rounded-lg bg-primary-600 text-on-primary hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none"
              >
      ...
      >
        ...
        >
          ...
          <button onClick={onComplete}
            className="mt-6 px-6 py-2.5 bg-primary-600 hover:bg-primary-700 text-on-primary rounded-lg font-medium transition-colors">
            Done
          </button>
        </div>
      </div>
        ...
        <div className="p-4 border-b border-surface-100 dark:border-surface-800">
          <div className="flex gap-2">
            ...
            <button onClick={() => handleScan(barcodeInput)} disabled={!barcodeInput.trim() || scanning}
              className="px-4 py-2 bg-primary-600 text-on-primary rounded-lg text-sm font-medium hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none">
              Add
            </button>
          </div>
          ...
          <div className="p-4 border-t border-surface-200 dark:border-surface-700 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <button onClick={handleReceiveAll} disabled={submitting || readyCount === 0}
                className="px-5 py-2 text-sm font-semibold rounded-lg bg-primary-600 text-on-primary hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none inline-flex items-center gap-1.5">
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
      ...
      <div className="mt-5 flex items-center gap-3">
        <Link
          to="/inventory/new"
          className="inline-flex items-center gap-2 px-4 py-2 bg-primary-600 text-on-primary rounded-lg text-sm font-medium hover:bg-primary-700 transition-colors"
        >
