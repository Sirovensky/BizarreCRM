...
const TICKET_SETTINGS: SettingDef[] = [
  ...
  {
    key: 'ticket_default_sort',
    label: 'Default Date Sort',
    tab: 'tickets-repairs',
    status: 'live',
    tooltip: 'Default sort column used by the ticket list when the URL has no explicit sort.',
    default: 'urgency',
    type: 'select',
    options: [
      ...
      { label: 'Ticket Number', value: 'order_id' },
  ...
  },
  {
    ...
    tab: 'tickets-repairs',
    status: 'live',
    tooltip: 'Default sort direction used by the ticket list when the URL has no explicit sort.',
    default: 'DESC',
    type: 'select',
    options: [
...
const RECEIPT_SETTINGS: SettingDef[] = [
  ...
  },
  {
    ...
    tab: 'receipts',
    status: 'live',
    tooltip: 'Includes service/warranty detail on thermal receipts.',
    default: false,
    type: 'boolean',
  },
  {
    ...
    tab: 'receipts',
    status: 'live',
    tooltip: 'Prints the device location on receipts when one is set on the repair device.',
    default: false,
    type: 'boolean',
  },
  {
...
const NOTIFICATION_SETTINGS: SettingDef[] = [
  ...
  },
  {
    ...
    tab: 'notifications',
    status: 'live',
    tooltip: 'Controls batching for queued email notifications. SMS notifications remain immediate for compliance and timeliness.',
    default: 'immediate',
    type: 'select',
    options: [
  ...
  },
  {
    ...
    tab: 'notifications',
    status: 'live',
    tooltip: 'Local hour for daily queued email notification digests.',
    default: 9,
    type: 'number',
    min: 0,
    max: 23,
...
const INTEGRATION_SETTINGS: SettingDef[] = [
  ...
  },
  {
    ...
    tab: 'store',
    status: 'live',
    tooltip: 'Primary accent color applied to buttons, links, focus rings, selected rows, and branded accents.',
    default: '#fdeed0',
    type: 'color',
  },
  {
    ...
    tab: 'sms-voice',
    status: 'beta',
    tooltip: '3CX PBX base URL used for Call Control click-to-call when host, extension, and API key are configured.',
    default: '',
    type: 'string',
    requiresRole: 'admin',
  },
  {
    key: 'tcx_password',
    label: '3CX API key / password',
    tab: 'sms-voice',
    status: 'beta',
    tooltip: 'Encrypted 3CX API key used to request Call Control access tokens.',
    default: '',
    type: 'string',
    requiresRole: 'admin',
  },
  {
    ...
    tab: 'sms-voice',
    status: 'beta',
    tooltip: '3CX DN/extension used as the Call Control source for CRM click-to-call.',
    default: '',
    type: 'string',
    requiresRole: 'admin',
  },
  {
    ...
    tab: 'notifications',
    status: 'live',
    tooltip: 'Incoming leads are assigned by the lead route using off, round-robin, or least-loaded mode.',
    default: 'off',
    type: 'select',
    options: [
      { label: 'Off', value: 'off' },
  ...
  },
  {
    ...
    tab: 'notifications',
    status: 'live',
    tooltip: 'Hourly estimate follow-up job sends SMS reminders for sent estimates older than this many days. Use 0 to disable.',
    default: 3,
    type: 'number',
    min: 0,
    max: 30,
