    ...
    <div className="flex h-full flex-col overflow-hidden">
      <div className="flex-shrink-0 space-y-3 px-4 pt-3 pb-4">
        ...
        <button
          ...
          className="btn btn-md w-full bg-primary-600 !font-semibold text-primary-950 hover:bg-primary-700 disabled:cursor-not-allowed disabled:opacity-50 disabled:pointer-events-none"
        >
