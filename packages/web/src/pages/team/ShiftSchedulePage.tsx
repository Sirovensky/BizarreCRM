    ...
    <div className="p-6 max-w-7xl mx-auto">
      <header className="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          ...
          {canManageSchedule ? (
            <button
              className="px-3 py-1.5 bg-primary-600 text-on-primary rounded text-sm hover:bg-primary-700 inline-flex items-center"
        ...
        <NewShiftModal open={showNew} onClose={() => setShowNew(false)}>
          <div className="bg-white dark:bg-surface-900 rounded-lg shadow-xl max-w-md w-full p-5 text-surface-900 dark:text-surface-100" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex gap-2 mt-5">
              ...
              <button
                className="flex-1 px-3 py-2 bg-primary-600 text-on-primary rounded text-sm hover:bg-primary-700 inline-flex items-center justify-center"
