  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={handlePay}
        disabled={loading}
        className="w-full rounded-md bg-primary-600 hover:bg-primary-700 text-on-primary font-medium py-2.5 text-sm disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
      >
