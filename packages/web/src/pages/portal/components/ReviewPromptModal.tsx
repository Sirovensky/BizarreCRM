          ...
          <>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex-1 rounded bg-primary-600 hover:bg-primary-700 text-on-primary py-2 text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none"
              >
                {t('review.submit')}
              </button>
            </div>
        ...
        {phase === 'thanks' ? (
          <div className="text-center">
            ...
            <button
              type="button"
              onClick={onClose}
              className="rounded bg-primary-600 hover:bg-primary-700 text-on-primary px-4 py-2 text-sm font-medium"
            >
              Close
            </button>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col gap-2">
              <a
                ...
                className="rounded bg-primary-600 hover:bg-primary-700 text-on-primary py-2 text-sm font-medium"
                onClick={onClose}
              >
