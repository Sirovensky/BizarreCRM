  ...
  return (
    <span ref={ref} className="relative inline-flex items-center gap-1">
      ...
      <button
        ...
        className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-[10px] font-bold hover:bg-blue-200 dark:hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-400"
      >
        ?
      </button>
      {open ? (
