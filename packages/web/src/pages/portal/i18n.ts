...
const EN: Dictionary = {
  ...
  'review.toast_cta': 'Happy with your repair?',
  'review.leave_review': 'Leave a review →',
  'trust.ssl': 'Encrypted connection',
  'trust.pci': 'Payment request',
...
const ES: Dictionary = {
  ...
  'photos.delete_failed': 'No se pudo eliminar la foto. Inténtalo de nuevo.',
  'photos.delete_window': 'Se puede eliminar durante {hours}h tras subirla.',
  'pay.title': 'Solicitud de pago',
  'pay.amount_due': 'Saldo: ${amount}',
  'pay.button': 'Ver solicitud de pago',
  'pay.paid': 'Pagado — ¡gracias!',
  'review.title': '¿Cómo lo hicimos?',
  'review.button_label': 'Reseña →',
  ...
  'review.toast_cta': '¿Contento con tu reparación?',
  'review.leave_review': 'Dejar reseña →',
  'trust.ssl': 'Conexión cifrada',
  'trust.pci': 'Solicitud de pago',
