...
const PAGE_JUMPS: PageJumpEntry[] = [
  ...
  { display: 'Pending QC', path: '/tickets/pending-qc', aliases: ['tickets', 'quality', 'sign off', 'qc'] },
  ...
  { display: 'My Queue', path: '/tickets?assigned_to=me', subtitle: '/tickets?assigned_to=me', aliases: ['tickets', 'team', 'queue', 'assigned'] },
