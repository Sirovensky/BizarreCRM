...
INSERT OR IGNORE INTO store_config (key, value) VALUES
  ...
  ('repair_pricing_a_label', 'Flagship'),
  ('repair_pricing_b_label', 'Mainstream'),
  ('repair_pricing_c_label', 'Legacy'),
  ('repair_pricing_unknown_label', 'Unknown'),
  ('repair_pricing_a_color', '#22c55e'),
  ('repair_pricing_b_color', '#0ea5e9'),
  ('repair_pricing_c_color', '#64748b'),
  ('repair_pricing_unknown_color', '#94a3b8'),
  ...
  ('repair_pricing_rounding_mode', 'off'),
  ('repair_pricing_auto_margin_rules', '[]'),
  ('repair_pricing_target_profit_green', '80'),
  ('repair_pricing_target_profit_amber', '40'),
  ('repair_pricing_tier_profit_thresholds', '{"tier_a":{"green":100,"amber":60,"red":30},"tier_b":{"green":80,"amber":40,"red":20},"tier_c":{"green":60,"amber":30,"red":10},"unknown":{"green":80,"amber":40,"red":20}}'),
