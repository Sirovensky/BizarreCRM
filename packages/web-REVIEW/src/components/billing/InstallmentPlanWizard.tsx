    ...
    <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
      ...
      <div className="flex justify-end gap-2">
        ...
        <button
          ...
          className="rounded-md bg-primary-600 px-4 py-2 text-sm font-semibold text-primary-950 hover:bg-primary-700 disabled:cursor-not-allowed disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none"
