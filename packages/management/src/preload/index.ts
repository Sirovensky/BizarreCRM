...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  management: {
    ...
    getRollbackInfo: () => ipcRenderer.invoke('management:get-rollback-info'),
    rollbackUpdate: () => ipcRenderer.invoke('management:rollback-update'),
    clearRollback: () => ipcRenderer.invoke('management:clear-rollback'),
