...
export function UpdatesPage() {
  ...
  return (
    <div className="space-y-3 lg:space-y-5 animate-fade-in">
      ...
      {/* DASH-ELEC-069: hide version card + actions while status is still loading
          to avoid "Unknown / Up to date" flash during the initial fetch. */}
      {!statusLoading && !statusError && (
        <>
          {/* Current version */}
      ...
      {/* Action buttons — always shown so operator can force-check even on error */}
