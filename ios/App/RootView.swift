...
private struct iPhoneTabs: View {
    ...
    var body: some View {
        TabView(selection: $selection) {
            ...
            CustomerListView(repo: CustomerRepositoryImpl(api: AppServices.shared.apiClient))
        ...
        NavigationStack {
            List {
                Section("Operations") {
                    ...
                    NavigationLink("Invoices") { InvoiceListView(repo: InvoiceRepositoryImpl(api: AppServices.shared.apiClient)) }
